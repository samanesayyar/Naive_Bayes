...
# LogisticRegression Accuracy: 0.7610619469026548
...
visualize = Visualize()
visualize.save_roc(X_train=X_train, y_train=y_train, classifier=LogisticRegression(), title='ROC Of LogisticRegression',
                   classes=[0, 1])
